...
app.CONFIG_FILE = MOCK / 'config_lopv_test.json'
app.BACKUP_DIR = MOCK / 'backups_lopv_test'
app.PROFILES_DIR = MOCK / 'profiles_lopv_test'
...
bak = app.BACKUP_DIR / 'mod_load_order.20260815_000000.bak'
...
(app.PROFILES_DIR / '打宝流.json').write_text(json.dumps({'mods': ['TestModB']}), encoding='utf-8')

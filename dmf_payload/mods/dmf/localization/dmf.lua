return {
  ...
  toggle_mods_description = {
    ...
    ["zh-cn"] = "临时启用或禁用安装的模组，{#color(255,255,140)}要完全禁用需要在mod_load_order.txt里删除模组英文名{#reset()}\n遇到问题联系B站丁香与黑醋栗，评论留言或私信发图，也可以加朋友的群951871341，我经常在群里冒泡，你发错误报告到群问题艾特我，我看看怎么解决问题",
  ...
  developer_mode_description = {
    ...
    ["zh-cn"] = "允许重新加载 DMF 和模组（CTRL+SHIFT+P），并启用一些调试功能。",
